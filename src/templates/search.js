  ...
  <div class="search-app">
    <div class="search-container">
      <form action="" class="search">
        ...
        ${
          args.suggestions.reduce((accumulator, suggestion) => {
            return `${accumulator}<a href class="c-tag u-mr-xs suggestion">${suggestion}</a>`
          }, '')
        }
        </fieldset>
            ...
            ${
              ...
              <div class="advanced-option">
                ...
                <select name="brand-filter" id="brand-filter" class="c-txt__input c-txt__input--select">
                  ...
                  ${
                    args.brands.reduce((accumulator, brand) => {
                      return `${accumulator}<option value='${brand.value}' ${brand.selected ? 'selected' : ''}>${brand.label}</option>`
                    }, '')
                  }
                </select>
              </div>
